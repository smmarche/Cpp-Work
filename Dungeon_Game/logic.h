...
using std::cin; using std::cout; using std::endl; using std::string; using std::ifstream;
 ...
 * Need to update the map tile that the player moves onto and return the appropriate status.
 * @param   map         Dungeon map.
 * @param   maxRow      Number of rows in the dungeon table (aka height).
 * @param   maxCol      Number of columns in the dungeon table (aka width).
